...
@rem Add path to CMAKE and CMAKE-GUI
set PATH=G:\desarrollo\cmake-3.7.0-rc1-win64-x64\bin;%PATH%

@rem Añado path para librerías
set PATH=G:\desarrollo\ogre1_9\build\sdk\lib\release;G:\desarrollo\ogre1_9\build\sdk\bin\release;G:\desarrollo\ogre1_9\build\sdk\lib\release\opt;G:\desarrollo\SDL-1.2.15src\VisualC\release;G:\desarrollo\SDL_mixer-1.2.12\VisualC\Release;G:\desarrollo\ogrebullet\build\Release;G:\desarrollo\mygui\build\lib\Release;G:\desarrollo\mygui\build\bin\release;G:\desarrollo\mxml-2.10\vcnet\Release;G:\desarrollo\bullet3-2.85.build\lib\Release;G:\desarrollo\boost_1_62_0\bin.v2\libs;G:\desarrollo\pthreads4w-code;G:\desarrollo\SDL-1.2.15src\VisualC\SDL\Release;G:\desarrollo\minicars;%PATH%
